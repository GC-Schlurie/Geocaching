...
#define MINDESTLAENGE_ZUM_GEWINNEN 15
...
void setup()
{
  ...
  mp3.begin(9600);
    ...
    mp3.playFileByIndexNumber(1);  //Ansage Soundmodul bei Start bzw. Stromzufuhr
...
void endGame()
{ if ( wormLength > MINDESTLAENGE_ZUM_GEWINNEN )
        mp3.playFileByIndexNumber(2);   // Gewinner
   else
        mp3.playFileByIndexNumber(3); // Verlierer , wg. zu kurz
  // delay (1000);      
  gameState = GAME_STATE_END;
